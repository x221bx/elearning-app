...
export default function TeacherDetail() {
    ...
    const languages = Array.isArray(teacher.languages) && teacher.languages.length ? teacher.languages : ["Arabic", "English"];
    ...
    const rating = Math.max(0, Math.min(5, Number(teacher.rating || 0))); // clamp 0..5
                            ...
                            <CardContent>
                                <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 2 }}>
                                    ...
                                    <Stack spacing={1} sx={{ width: "100%" }}>
                                        ...
                                        <Row label="Rating" value={rating.toFixed(1)} />
                        ...
                        <Card sx={{ borderRadius: 3 }}>
                            <CardContent>
                                ...
                                <Box sx={{ display: "grid", gap: 2 }}>
                                    {paginated.map((c) => (
                                        <Card key={c.id} variant="outlined" sx={{ borderRadius: 2, borderLeft: "4px solid #FBC02D" }}>
