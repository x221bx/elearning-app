            ...
            <CardContent>
              <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 2 }}>
                ...
                <Stack direction="row" spacing={1}>
                  <IconButton component="a" href={teacher.socials?.facebook || "#"} target="_blank" sx={{ color: "text.secondary" }}>
                    <Facebook />
                  </IconButton>
                  <IconButton component="a" href={teacher.socials?.instagram || "#"} target="_blank" sx={{ color: "text.secondary" }}>
                    <Instagram />
                  </IconButton>
                  <IconButton component="a" href={teacher.socials?.twitter || "#"} target="_blank" sx={{ color: "text.secondary" }}>
                    <Twitter />
                  </IconButton>
                  <IconButton component="a" href={teacher.socials?.linkedin || "#"} target="_blank" sx={{ color: "text.secondary" }}>
                    <LinkedIn />
                  </IconButton>
                  <IconButton component="a" href={teacher.socials?.youtube || "#"} target="_blank" sx={{ color: "text.secondary" }}>
                    <YouTube />
                  </IconButton>
                </Stack>
              </Box>
